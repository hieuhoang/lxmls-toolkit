...
class DependencyDecoder:
    ...
    def parse_proj(self, scores):
        ...
        """
        nr, nc = np.shape(scores)
        #print "scores=", scores.shape, scores, "nr=", nr, "nc=", nc
        ...
        #print "shapes=", complete.shape, incomplete.shape, complete_backtrack.shape, incomplete_backtrack.shape
